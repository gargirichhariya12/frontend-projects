...
const handleOutgoingMessages=(e) =>{
    ...
    outgoingMessageDiv.querySelector(".message-text").textContent = userData.message;//instead of textContent use innertext
...
//simulate bot response with thinking indicator after a delay
    setTimeout(() =>{
        ...
        //instead of textContent use innertext
...
//handle entery key press for sending messages
